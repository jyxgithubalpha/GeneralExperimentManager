"""
CatBoostTuner - CatBoost Optuna 参数调优器
"""
...
class CatBoostTuner(BaseTuner):
    ...
    def __init__(
        self,
        param_space: CatBoostParamSpace,
    ...
    def tune(
        ...
        try:
            ...
            raise ImportError("optuna is required for CatBoostTuner")
            ...
            if "val" in fit_result.evals_result:
                for key in fit_result.evals_result["val"]:
                    ...
                    if scores and len(scores) > 0:
                        best_idx = fit_result.best_iteration if fit_result.best_iteration else len(scores) - 1
